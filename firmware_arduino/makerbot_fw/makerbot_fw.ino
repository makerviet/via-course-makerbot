...
const char *password = "makerbotisnotthatfun";
...
// 'state' is the motor directions, the real direction also depends on how mottor wires are
// connectted to the motorshield
